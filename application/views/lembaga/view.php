...
<div class="row" style="background-color: white;">
      <div class="col-md-12 text-center ">
        <div class="panel panel-default">
          <div class="userprofile social ">
            ...
            <h3 class="username"><?php echo $lembaga_item['nama_lembaga']; ?></h3>
            <p>Gujarat, India</p>
          ...
          <div class="col-md-12 border-top border-bottom">
            <ul class="nav nav-pills pull-left countlist" role="tablist">
              <li role="presentation">
                <h3>123<br>
                  <small>Student</small> </h3>
              </li>
              <li role="presentation">
                <h3>242<br>
                  <small>Program</small> </h3>
              </li>
              <li role="presentation">
                <h3>4.5/5<br>
            ...
            <button class="btn btn-primary followbtn">Chat</button>
          </div>
      ...
      <div class="col-md-4 col-sm-12 pull-right">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h1 class="page-header small">tentang kami</h1>
            <p class="page-subtitle small"><?php echo $lembaga_item['nama_lembaga']; ?></p>
          </div>
          <div class="col-md-12 ">
            <div class="row">
             <?php echo $lembaga_item['deskripsi']; ?>
            </div>
          </div>
          <div class="clearfix"></div>
        </div>
      ...
      <div class="panel-heading">Program Paket</div>
