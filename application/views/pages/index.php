...
<div class="container" style="margin-top: 1%;">
      <!-- Jumbotron Header -->
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox" >
            ...
            <div class="carousel-item" style="background-image: url('http://placehold.it/1320x300')">
              <div class="carousel-caption d-none d-md-block">
                <h3>Second Slide</h3>
      ...
      <style>
        .outer{
            ...
            background: linear-gradient(to right, #f3eeee, white);
        }

        .headerbar{
            background: #f3780c !important;
                      ...
                      <div class="col-md-12 col-md-offset-12" >
                        <div class="panel panel-default outer" >
                          ...
                          <div class="panel-body text-justify">
                            ...
                            laborumlorem  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
